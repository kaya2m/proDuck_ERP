...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("proDuck.Domain.Entities.Customer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("proDuck.Domain.Entities.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("proDuck.Domain.Entities.Product", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("proDuck.Domain.Entities.InvoiceFiles", b =>
                {
            ...
            modelBuilder.Entity("proDuck.Domain.Entities.Order", b =>
                {
                    b.HasOne("proDuck.Domain.Entities.Customer", "Customer")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("OrderProduct", b =>
                {
                    b.HasOne("proDuck.Domain.Entities.Order", null)
                        .WithMany()
                        .HasForeignKey("OrdersId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("proDuck.Domain.Entities.Product", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ProductProductImageFiles", b =>
                {
                    b.HasOne("proDuck.Domain.Entities.ProductImageFiles", null)
                        .WithMany()
